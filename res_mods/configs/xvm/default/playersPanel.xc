...
///////////////////////////////////////////
    "short": {
      ...
      "nickMinWidth": 46,
      "nickMaxWidth": 158,
      "nickFormatLeft": "<font face='mono' size='{{xvm-stat?13|0}}' color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{r}}</font> {{name%.15s~..}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}}<font alpha='#A0'>{{clan}}</font>",
      "nickFormatRight": "<font alpha='#A0'>{{clan}}</font>{{name%.15s~..}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}} <font face='mono' size='{{xvm-stat?13|0}}' color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{r}}</font>",
      "nickShadowLeft": null,
...
///////////////////////////////////////////
    "medium": {
      ...
      "nickMinWidth": 46,
      "nickMaxWidth": 158,
      "nickFormatLeft": "<font alpha='#A0'>{{clan}}</font> <font color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{name}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}}</font>",
      "nickFormatRight": "<font color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{name}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}}</font> <font alpha='#A0'>{{clan}}</font>",
      "nickShadowLeft": null,
      "nickShadowRight": null,
      "vehicleOffsetXLeft": 0,
      "vehicleOffsetXRight": 0,
...
///////////////////////////////////////////
    "medium2": {
      ...
      "vehicleOffsetXRight": 0,
      "vehicleWidth": 72,
      "vehicleFormatLeft": "<font color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{vehicle}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}}</font>",
      "vehicleFormatRight": "<font color='{{c:r|{{.colors.anonymousColor}}}}' alpha='{{alive?#FF|#80}}'>{{vehicle}}{{my-anonym? <img src='cfg://default/icons/anonim.png' vspace='-3'>}}</font>",
      "vehicleShadowLeft": null,
      "vehicleShadowRight": null,
      "fixedPosition": false,
      "extraFieldsLeft": [
