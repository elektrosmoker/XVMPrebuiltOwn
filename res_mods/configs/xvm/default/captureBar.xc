  ...
  "captureBar": {
    ...
    "enemy": {
      ...
      "title": {
        ...
        // Text format
        // Формат текста
        "format": "<font size='15' color='#FFFFFF'>{{l10n:allyBaseCapture}}</font> <font size='14' color='#EBBB0F'>{{cap.points}}%</font>",
        // Full capture text format
        // Формат текста при полном захвате
        "done": "<font size='15' color='#FFFFFF'>{{l10n:allyBaseCaptured}}</font> <font size='14' color='#EBBB0F'>{{cap.points}}%</font>",
        // Shadow options
        // Параметры тени
        "shadow": {
          // false - no shadow
      ...
      "players": {
        "x": -218,
        "y": 0,
        "format": "<font face='xvm' size='16' color='#FFFFFF'>&#x27;</font>  <font color='#EBBB0F'><b>{{cap.tanks}}</b></font>",
        "done": "<font face='xvm' size='16' color='#FFFFFF'>&#x27;</font>  <font color='#EBBB0F'><b>{{cap.tanks}}</b></font>",
        "shadow": {
          "color": "0x000000",
          "alpha": 35,
          "blur": 3,
      ...
      "timer": {
        "x": 200,
        "y": 0,
        "format": "<font face='xvm' size='15' color='#FFFFFF'>&#x114;</font>  <font color='#EBBB0F'><b>{{cap.time}}</b></font>",
        "done": "<font face='xvm' size='15' color='#FFFFFF'>&#x114;</font>  <font color='#EBBB0F'><b>{{cap.time}}</b></font>",
        "shadow": {
          "color": "0x000000",
          "alpha": 35,
          "blur": 3,
    ...
    "ally": {
      ...
      "title": {
        ...
        "format": "<font size='15' color='#FFFFFF'>{{l10n:enemyBaseCapture}}</font> <font size='14' color='#EBBB0F'>{{cap.points}}%</font>",
        "done": "<font size='15' color='#FFFFFF'>{{l10n:enemyBaseCaptured}}</font> <font size='14' color='#EBBB0F'>{{cap.points}}%</font>"
      },
