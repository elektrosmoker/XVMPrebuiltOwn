...
"EfficiencyReportBackground": {
      ...
      "valign": "center",
      "alpha": 40,
      "format": "{{battletype-key=regular?<img src='xvm://res/icons/MarsOne/bg300x300.png' width='300' height='145'>}}"
    },
