        ...
        "formats": [
            {
                ...
                "textFormat":   { "font": "DinPro-Bold", "color": "0x990075", "size": 15, "align": "left", "valign": "top"},
                "format":       "<u>Personal Stats + (beta):<\u>"
            }
        ]
    },
    ...
    "formats": [
      {
        ...
        "shadow": {
          ...
          "color": "0x005500",       // "0xXXXXXX"      / color           
          "alpha": 70,               // (0 .. 100)      / opacity         
          "blur": 4,                 // (0.0 .. 255.0)  / blur            
          "strength": 2              // (0.0 .. 255.0)  / intensity       
        },
        "textFormat": { "align": "left", "valign": "top", "color": "0x10bc99" },
